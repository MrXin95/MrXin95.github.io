!function (t) {
    ...
    var o = AFRAME.utils.debug, n = AFRAME.utils.coordinates, r = o("components:look-at:warn"),
    ...
    delete AFRAME.components["look-at"], AFRAME.registerComponent("look-at", {
        schema: {
            ...
            var t, e = this, o = e.data, n = e.el.object3D;
            ...
            return function (e) {
                var o = this.target3D, n = this.el.object3D, r = this.vector;
                o && (o.getWorldPosition(t), this.el.getObject3D("camera") || (r = t), n.lookAt(r))
            }
